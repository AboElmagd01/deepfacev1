...
def analysis(db_path, model_name, distance_metric, enable_face_analysis = True
				, source = 0, time_threshold = 1, frame_threshold = 30):
					...
					for detected_face in detected_faces_final:
						...
						if enable_face_analysis == True:
							...
							for index, instance in emotion_df.iterrows():
								...
								labelx = {'label': emotion_label , 'score':emotion_score}
								...
								ser = pd.Series(data=labelx, index=['label', 'score'])
								...
								if x+w+pivot_img_size < resolution_x:
									...
									if text_location_y <= y+h:
										...
										if emotion_label != 'Happy':
											cv2.cv2.putText(freeze_img, "Smile", (40, 70), cv2.FONT_HERSHEY_SIMPLEX, 3,
															(255, 255, 255), 1)
